...
class Exercise08ControllerTest extends TestCase
{
    ...
    public function test_calculate_discount_with_rule1()
    {
        $age = 12;
        $date = '2021-05-01';
        $gender = 'male';
    ...
    public function test_calculate_discount_with_rule2()
    {
        $age = 14;
        $date = '2021-04-20';
        $gender = 'male';
    ...
    public function test_calculate_discount_with_rule3()
    {
        $age = 14;
        $date = '2021-04-30';
        $gender = 'female';
    ...
    public function test_calculate_discount_with_rule4()
    {
        $age = 14;
        $date = '2021-04-30';
        $gender = 'male';
    ...
    public function test_calculate_discount_with_rule5()
    {
        $age = 66;
        $date = '2021-04-30';
        $gender = 'male';
    ...
    public function test_calculate_discount_with_rule6()
    {
        $age = 20;
        $date = '2021-05-01';
        $gender = 'female';
