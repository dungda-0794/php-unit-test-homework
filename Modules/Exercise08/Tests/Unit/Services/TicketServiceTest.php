...
class TicketServiceTest extends TestCase
{
    ...
    public function test_calculate_price_age_less_than_13_is_tuesday()
    {
        $param = [
            'age' => 12,
            'booking_date' => '2021-04-20',
    ...
    public function test_calculate_price_age_more_than_65_is_tuesday()
    {
        $param = [
            'age' => 70,
            'booking_date' => '2021-04-20',
    ...
    public function test_calculate_is_woman_and_friday_age_less_than_13()
    {
        $param = [
            'age' => 12,
            'booking_date' => '2021-04-23',
