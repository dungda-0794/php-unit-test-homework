...
class TicketServiceTest extends TestCase
{
    ...
    public function test_negative_age()
    {
        $param = [
            'age' => -1,
            'booking_date' => '',
    ...
    public function test_age_more_than_120()
    {
        $param = [
            'age' => 121,
            'booking_date' => '',
    ...
    public function test_age_equal_0()
    {
        $param = [
            'age' => 0,
            'booking_date' => '',
    ...
    public function test_age_less_than_13()
    {
        $param = [
            'age' => 12,
            'booking_date' => '',
    ...
    public function test_age_equal_13()
    {
        $param = [
            'age' => 13,
            'booking_date' => '',
    ...
    public function test_is_tuesday()
    {
        $param = [
            'age' => 15,
    ...
    public function test_woman_and_not_friday()
    {
        $param = [
            'age' => 15,
    ...
    public function test_not_woman_and_friday()
    {
        $param = [
            'age' => 15,
    ...
    public function test_woman_and_friday()
    {
        $param = [
            'age' => 15,
            'booking_date' => '2021-04-23',
    ...
    public function test_friday_age_more_than_65()
    {
        $param = [
            'age' => 66,
            'booking_date' => '2021-04-23',
    ...
    public function test_age_more_than_65()
    {
        $param = [
            'age' => 66,
    ...
    public function test_age_equal_65()
    {
        $param = [
            'age' => 65,
            'booking_date' => '2021-04-22',
